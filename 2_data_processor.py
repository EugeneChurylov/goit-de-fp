...
class SparkKafkaProcessor:
    ...
    def _create_spark_session(self) -> SparkSession:
        ...
        mysql_jar_path = os.path.abspath("/Users/eugenechurylov/PycharmProjects/pythonProject9/.venv/mysql-connector-j-8.3.0.jar")
    ...
    def process_stream(self, topic_prefix: str = "churylov_yevhen_0107") -> None:
